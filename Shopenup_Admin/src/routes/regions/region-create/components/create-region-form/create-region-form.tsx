...
import { PaymentProviderDTO, RegionCountryDTO } from "@shopenup/types"
                        ...
                        <Form.Item>
                          ...
                          <Form.Control>
                            <select
                              ...
                              onBlur={field.onBlur}
                              name={field.name}
                              className="txt-compact-small-plus shadow-borders-focus transition-fg flex h-9 w-full items-center rounded-md border border-ui-border-base bg-ui-bg-field px-2.5 text-ui-fg-base outline-none focus-visible:border-ui-border-interactive dark:bg-ui-bg-field dark:text-ui-fg-base"
                            >
                              <option
                                value=""
                                disabled
                                className="bg-ui-bg-base text-ui-fg-muted dark:bg-ui-bg-base dark:text-ui-fg-muted"
                              >
                                Select a currency
                              </option>
                              {currencies.map((currency) => (
                                <option
                                  value={currency.code}
                                  key={currency.code}
                                  className="bg-ui-bg-base text-ui-fg-base dark:bg-ui-bg-base dark:text-ui-fg-base"
                                >
                                  {currency.name}
                                </option>
                              ))}
